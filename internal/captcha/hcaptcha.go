...
func init() {
	Register("hcaptcha", func(secretKey string) (Provider, error) {
...
func (p *hcaptchaProvider) Verify(ctx context.Context, token, remoteIP, expectedAction string) error {
